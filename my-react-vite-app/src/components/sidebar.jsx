            ...
            <ul className="level-0">
                ...
                <li className="unselected topLevel">
                    ...
                    <div className="name">
                        ...
                        <a href="#">Food</a>
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</span>                  
                            <IoIosArrowForward className="arrow-icon" style={{ transform: `rotate(${rotations[7] || 0}deg)` }} onClick={(e) => {e.preventDefault();  e.stopPropagation();  toggleDropdown(7); }}/>
                    </div>
                {dropdowns[7] && (
                    ...
                    <div className="name">
                        ...
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</span>                  
                    <IoIosArrowForward
                    className="arrow-icon" style={{ transform: `rotate(${rotations[12] || 0}deg)` }} onClick={(e) => {toggleDropdown(12); }} />
                {dropdowns[12] && (
