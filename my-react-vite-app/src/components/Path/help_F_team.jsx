                                ...
                                <section className="team-section">
                                    ...
                                    <div className="team-block">
                                        ...
                                        <div className={`individualTeam ${selectedMembers[15] ? 'selected' : ''}`} onClick={() => toggleSelected(15)}>
                                            ...
                                            <div className="info-block">
                                                <div className="name">Md. Sumon Mallik</div>
                                                <div className="position">Director of Operations</div>
                                                <div className="description">
                                            ...
                                            {selectedMembers[15] && (
                                            <div className="arrowClass arrowClassHide">
                                                <div className="arrowHolder">
                                        ...
                                        <div className={`individualTeam ${selectedMembers[16] ? 'selected' : ''}`} onClick={() => toggleSelected(16)}>
                                            ...
                                            <div className="info-block">
                                                <div className="name">SK Ahammad Fahad</div>
                                        ...
                                        <div className={`individualTeam ${selectedMembers[17] ? 'selected' : ''}`} onClick={() => toggleSelected(17)}>
                                            ...
                                            <div className="info-block">
                                                <div className="name">Rezaur Rahman Jitu</div>
                                                <div className="position">VP Engineering</div>
                                                <div className="description">
                                        ...
                                        <div className={`individualTeam ${selectedMembers[18] ? 'selected' : ''}`} onClick={() => toggleSelected(18)}>
                                            ...
                                            <div className="info-block">
                                                <div className="name">Mahbub M M Muntasin</div>
                                                <div className="position">Sr. Director, CDVN</div>
                                                <div className="description">
                                        ...
                                        <div className={`individualTeam ${selectedMembers[19] ? 'selected' : ''}`} onClick={() => toggleSelected(19)}>
                                            ...
                                            <div className="info-block">
                                                <div className="name">Md. Kamruzzaman</div>
                                                <div className="position">Director of Central Planning</div>
                                                <div className="description">
