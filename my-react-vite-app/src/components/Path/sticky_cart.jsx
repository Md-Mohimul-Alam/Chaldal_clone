                                ...
                                <ul>
                                    {cart.map((item, index) => (
                                        <li key={index} className="item_dis">
                                            ...
                                            <div className="remove" title="Remove from bag" onClick={removeFromCart} style={{height:'auto', width: 'auto'}}>
                                                <svg version="1.1" x="0px" y="0px" viewBox="0 0 100 100">
                                                    <rect x="19.49" y="46.963" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 121.571 49.0636)" width="62.267" height="5.495" />
                                                    <rect x="18.575" y="47.876" transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 49.062 121.5686)" width="62.268" height="5.495" />
                                                </svg>
                                            </div>
