      ...
      <STC_ChT/>
        ...
        <div className={`hamburgerMenu ${isActive ? 'active' : ''}`}
          ...
          <div className="lcn">
            ...
            <div className="login_D" onClick={handleShowLoginPopup}>
              <div className='login'>
                <div className='btn'>
                  Login
                </div>
              ...
              <PopupComponent show={showLoginPopup} handleClose={handleCloseLoginPopup} />
            </div>
        </div>
      ...
      <div className='compress'style={divStyle}>
        <div className="landingBanner" style={{ background: 'url(https://chaldn.com/asset/Egg.ChaldalWeb.Fabric/Egg.ChaldalWeb1/1.0.0-Deploy-Release-505/Default/stores/chaldal/components/landingPage2/LandingPage/images/landingBanner.png) no-repeat center', backgroundSize: 'cover', flex: '1' }}>
          ...
          <div className="banner-image">
            <img src="https://chaldn.com/asset/Egg.ChaldalWeb.Fabric/Egg.ChaldalWeb1/1.0.0-Deploy-Release-518/Default/stores/chaldal/components/landingPage2/LandingPage/images/imageBanner.png?q=low&webp=1" alt="banner" />
          </div>
        </div>
        <DeliveryInfo/>
      </div>
