...
const Dashboard = () => {
  ...
  return (
    <Link className='dashboard-container'>
      ...
      {!isCartOpen && (
                <section className={`stickyHeader ${isActive ? 'active' : ''}`}
                    ...
                    <div className="itemCount">
                        <svg version="1.1" id="Calque_1" x="0px" y="0px" style={{ fill: '#FDD670', stroke: '#FDD670' }} width="16px" height="24px" viewBox="0 0 100 160.13">
                            <g data-reactid=".p03dxpkr6w.3.0.3.2.0.0.0"><polygon points="11.052,154.666 21.987,143.115 35.409,154.666"></polygon>
                                ...
                                c-0.007-0.557-0.01-1.112-0.021-1.665l6.549,0.39L83.165,40.766z"></path></g>
                        </svg>
                    ...
                    <div className="total" style={{ color: 'black' }}>
                        ...
                        <div className="odometer odometer-auto-theme odometer-animating-down odometer-animating">
                            {/* Odometer digits content */}
                            <span>00.00 </span>
                        </div>
                    </div>
                </section>
            )}
            {isCartOpen && <CartSidebar isCartOpen={isCartOpen} toggleCart={toggleCart} />}
